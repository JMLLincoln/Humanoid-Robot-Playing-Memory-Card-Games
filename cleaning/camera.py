...
class Feed:
    ...
    def get_rect(self, contour):
        ''' Take a contour and return a rotated rect '''
...
class Geometry:
    ...
    # Realised this is pointless because cv2.minAreaRect does
    # this for me. Leaving it here for now though because it
    # uses maths magic
