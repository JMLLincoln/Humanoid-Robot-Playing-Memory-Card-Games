...
function startGame(fps) {
	...
	if (true/*document.getElementById('socket_state').innerHTML == "socket open"*/) {
		init();
...
function parseMessage(message) {
	...
	card_values = JSON.parse(arr[0]);
	card_states = JSON.parse(arr[1]);
}
...
function update() {
	...
	pscoreLabel.innerHTML = "You have " + 0 + " cards!";
	bscoreLabel.innerHTML = "I have " + 0 + " cards!";
}